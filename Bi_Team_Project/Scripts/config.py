...
class Config(Properties):
    ...
    def __init__(self, start_date, ioid, end_date):  # start_date,end_date):
        ...
        self.path = (self.save + "{}.xlsx".format(self.ioid))
    ...
    def common_columns_summary(self):
        ...
        sql_end_date = "SELECT TO_CHAR(MAX(EDATE),'YYYY-MM-DD') as EDATENEW from TFR_REP.EOC_SUMMARY_VIEW WHERE IO_ID = {}".format(
            self.ioid)
