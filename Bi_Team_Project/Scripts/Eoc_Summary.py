...
class Summary():
    ...
    def access_data_summary(self):
        ...
        try:
            vdx_access_table = vdx_second_Table[["PLACEMENT#", "START_DATE", "END_DATE", "PLACEMENT_NAME",
                                                 "COST_TYPE", "UNIT_COST", "PLANNED_COST",
                                                 "BOOKED_IMP#BOOKED_ENG", "Delivered_Engagements",
    ...
    def rename_cols_sumary(self):
        ...
        display_rename = display_first_Table.rename( columns={
            "PLACEMENT#":"Placement#",
    ...
    def write_summary(self):
        ...
        if check_preroll_empty==True:
            ...
            preroll_write = preroll_access_table.to_excel( self.config.writer,
                                                           sheet_name="Summary({})".format( self.config.IO_ID ),
                                                           startcol=3,
                                                           startrow=len( display_first_Table )+len(
                                                               vdx_access_table )+18,
                                                           header=True, index=False )
    ...
    def format_summary(self):
        ...
        if check_preroll_empty==True:
            ...
            worksheet.write( number_rows_commom+number_rows_display+number_rows_vdx+number_rows_preroll+16, 3,
                             "Subtotal",
                             format_subtotal )
        ...
        if check_disp_empty==True:
            ...
            worksheet.conditional_format( number_rows_commom+number_rows_display+7, 3,
                                          number_rows_commom+number_rows_display+7
        ...
        if check_vdx_empty==True:
            ...
            worksheet.conditional_format( number_rows_commom+number_rows_display+number_rows_vdx+12, 3,
                                          number_rows_commom+number_rows_display+number_rows_vdx+12, number_cols_vdx+2,
        ...
        if check_preroll_empty==True:
            ...
            worksheet.conditional_format( number_rows_commom+number_rows_display+number_rows_vdx+number_rows_preroll+17,
                                          3,
                                          number_rows_commom+number_rows_display+number_rows_vdx+number_rows_preroll+17,
        ...
        if check_vdx_empty==True:
            ...
            worksheet.merge_range( number_rows_commom+number_rows_display+9, 3,
                                   number_rows_commom+number_rows_display+9,
        ...
        if check_disp_empty==True:
            ...
            worksheet.merge_range( number_rows_commom+5, 1, number_rows_commom+number_rows_display+6, 2,
        ...
        if check_vdx_empty==True:
            ...
            worksheet.merge_range( number_rows_commom+number_rows_display+10, 1,
        ...
        if check_preroll_empty==True:
            ...
            worksheet.merge_range( number_rows_commom+number_rows_display+number_rows_vdx+15, 1,
        ...
        if check_disp_empty==True:
            ...
            worksheet.conditional_format( number_rows_commom+5, 14,
                                          number_rows_commom+number_rows_display+6, 14,
                                          {"type":"blanks", "format":format_border_left} )
    
        if check_vdx_empty==True:
            pass
        else:
            worksheet.conditional_format( number_rows_commom+number_rows_display+10, 15,
                                          number_rows_commom+number_rows_display+number_rows_vdx+11, 15,
                                          {"type":"blanks", "format":format_border_left} )
    
        if check_preroll_empty==True:
            pass
        else:
            worksheet.conditional_format( number_rows_commom+number_rows_display+number_rows_vdx+15, 14,
                                          number_rows_commom+number_rows_display+number_rows_vdx+number_rows_preroll+16,
...
if __name__=="__main__":
    ...
    # c=config.Config("test", 565337, '2017-10-01', '2017-10-31')
    # o=Summary(c)
    # o.main()
