...
NET_UNIT_COST as NET_UNIT_COST, GROSS_UNIT_COST as GROSS_UNIT_COST, NET_BUDGET as NET_PLANNED_COST, GROSS_BUDGET as GROSS_PLANNED_COST, BOOKED_QTY AS BOOKED_IMP#BOOKED_ENG FROM TFR_REP.SUMMARY_MV
WHERE (IO_ID = {0})
	 AND (DATA_SOURCE = 'KM')
	 ...
	 AND CREATIVE_DESC IN(SELECT DISTINCT CREATIVE_DESC
						  FROM TFR_REP.SUMMARY_MV)ORDER BY PLACEMENT_ID)
