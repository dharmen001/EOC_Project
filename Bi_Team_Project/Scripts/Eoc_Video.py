...
Class for VDX Placements
	...
	def formatting_Video(self):
		...
		number_cols_plc_summary = 0
		number_cols_adsize = 0
		number_cols_video = 0
...
Main Function
		...
		if self.read_sql_vdx_km.empty or self.read_sql_adsize_km.empty or self.read_sql_video_km.empty:
