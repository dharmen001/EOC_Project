		...
		try:
			...
			if check_day_preroll_summary_final is True:
				...
				for placement,placement_df in dayprerollsummaryfinal.groupby('Placement# Name'):
					...
					worksheet.conditional_format(end_row, 1, end_row, 6,{"type":"no_blanks","format":format_subtotal})
					worksheet.conditional_format(end_row+3, 1, end_row+3, 6,{"type":"no_blanks","format":format_subtotal})
					#worksheet.conditional_format(end_row+3, 1, end_row+3, 6, {"type":"blanks", "format":format_subtotal})
					worksheet.conditional_format(start_row,2,end_row,3,{"type":"no_blanks","format":format_number})
					worksheet.conditional_format(start_row,4,end_row,4,{"type":"no_blanks","format":percent_fmt})
					worksheet.conditional_format( start_row, 5, end_row, 5, {"type":"no_blanks", "format":format_number})
					...
					worksheet.conditional_format(start_row-1,3,start_row-1,3,{"type":"text", 'criteria':'containing','value':'Clickthroughs',
					                                                        'format':format_placement_by_date_header})
					
					worksheet.conditional_format(start_row-1,4,start_row-1,4,{"type":"text", 'criteria':'containing','value':'CTR',
					                                                        'format':format_placement_by_date_header})
					worksheet.conditional_format(start_row-1,5,start_row-1,5,{"type":"text", 'criteria':'containing','value':'Video Completions',
					                                                        'format':format_placement_by_date_header})
					worksheet.conditional_format(start_row-1,6,start_row-1,6,{"type":"text", 'criteria':'containing',
					                                                        'value':'Video Completion Rate','format':format_placement_by_date_header})
					
					worksheet.conditional_format(start_row-2,1,start_row-2,6,{'type':'blanks','format':format_subtotal})
					worksheet.conditional_format(start_row-2,1,start_row-2,6,{'type':'no_blanks','format':format_subtotal})
...
Applying Formatting
		...
		try:
			...
			if check_day_preroll_summary_final is True:
				...
				worksheet.merge_range(7,1,7,number_cols_preroll_summary,"Standard Pre Roll Performance - Summary",format_merge_row)
				worksheet.conditional_format(8,1,8,number_cols_preroll_summary,{"type":"no_blanks","format":format_headers})
				worksheet.conditional_format(9,3, number_rows_preroll_summary+8, 3,
				                              {"type":"no_blanks", "format":money_fmt})
				worksheet.conditional_format(9, 4, number_rows_preroll_summary+8, 5, {"type":"no_blanks", "format":format_number})
				worksheet.conditional_format(9, 6, number_rows_preroll_summary+8, 6,
				                              {"type":"no_blanks", "format":percent_fmt})
				worksheet.conditional_format(9,7,number_rows_preroll_summary+8,7,{"type":"no_blanks", "format":format_number})
				worksheet.conditional_format(9,8,number_rows_preroll_summary+8,8,{"type":"no_blanks", "format":percent_fmt})
				worksheet.write_string(number_rows_preroll_summary+9,1,"Subtotal")
				worksheet.write_formula(number_rows_preroll_summary+9,4,'=sum(E{}:E{})'.format(10,number_rows_preroll_summary+9),format_number)
				worksheet.write_formula(number_rows_preroll_summary+9,5,'=sum(F{}:F{})'.format(10, number_rows_preroll_summary+9),format_number)
				worksheet.write_formula(number_rows_preroll_summary+9,6,'=IFERROR((F{}/E{}),0)'.format(number_rows_preroll_summary+10,number_rows_preroll_summary+10),percent_fmt)
				worksheet.write_formula(number_rows_preroll_summary+9,7,'=sum(H{}:H{})'.format(10, number_rows_preroll_summary+9),format_number)
				...
				worksheet.conditional_format(8,0,number_rows_preroll_summary+9,0,{"type":"blanks","format":format_border_right})
				worksheet.conditional_format(8,number_cols_preroll_summary+1,number_rows_preroll_summary+9,
				                             number_cols_preroll_summary+1,{"type":"blanks","format":format_border_left})
				worksheet.conditional_format(number_rows_preroll_summary+10,1,number_rows_preroll_summary+10,number_cols_preroll_summary,
				                             {"type":"blanks","format":format_border_top})
				worksheet.conditional_format(number_rows_preroll_summary+9,1,number_rows_preroll_summary+9,number_cols_preroll_summary,
				...
				worksheet.conditional_format(number_rows_preroll_summary+9, 1, number_rows_preroll_summary+9,
				                              number_cols_preroll_summary,{"type":"no_blanks","format":format_headers})
			...
			if check_video_preroll_summary_mv_final is True:
				...
				worksheet.conditional_format(number_rows_preroll_summary+13, 1, number_rows_preroll_summary+13,
				                             number_cols_video_preroll_summary,{"type":"no_blanks", "format":format_headers})
				worksheet.conditional_format(number_rows_preroll_summary+14,2,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary+14,6,{"type":"no_blanks",
				                                                                                          "format":format_number})
				worksheet.conditional_format(number_rows_preroll_summary+14,7,number_rows_preroll_summary+number_rows_video_preroll_summary+14,7,
				                             {"type":"no_blanks","format":percent_fmt})
				...
				worksheet.write_formula(number_rows_preroll_summary+number_rows_video_preroll_summary+14,2,
				                        '=sum(C{}:C{})'.format(number_rows_preroll_summary+15,number_rows_preroll_summary+number_rows_video_preroll_summary+14))
				...
				worksheet.write_formula(number_rows_preroll_summary+number_rows_video_preroll_summary+14, 4,
				                         '=sum(E{}:E{})'.format(number_rows_preroll_summary+15,number_rows_preroll_summary+number_rows_video_preroll_summary+14))
				...
				worksheet.write_formula(number_rows_preroll_summary+number_rows_video_preroll_summary+14, 6,
				                         '=sum(G{}:G{})'.format(number_rows_preroll_summary+15,number_rows_preroll_summary+number_rows_video_preroll_summary+14))
				
				worksheet.write_formula(number_rows_preroll_summary+number_rows_video_preroll_summary+14, 7,
				                        '=IFERROR((G{}/C{}),0)'.format(number_rows_preroll_summary+number_rows_video_preroll_summary+15,
				...
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+15,1,
				                             ...
				                             number_cols_video_preroll_summary,{"type":"blanks","format":format_border_top})
			
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+14,1,number_rows_preroll_summary+number_rows_video_preroll_summary+14,
				                             number_cols_video_preroll_summary,{"type":"no_blanks","format":format_headers})
			...
			if check_interaction_final is True:
				...
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+18,1,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary+18,number_cols_interaction_final,
				                             {"type":"no_blanks", "format":format_headers})
				
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+19,number_cols_interaction_final-2,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19,
				                             number_cols_interaction_final-2,{"type":"no_blanks", "format":format_number})
				
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+19,number_cols_interaction_final-1,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19,
				                             number_cols_interaction_final-1,{"type":"no_blanks", "format":percent_fmt})
				
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+19,number_cols_interaction_final,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary
				                             +number_rows_interaction_final+19,number_cols_interaction_final,{"type":"no_blanks", "format":format_number})
				worksheet.write_string(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19,1,
				                       "Subtotal")
				
				
				for col in range(2,number_cols_interaction_final-1):
					cell_location = xl_rowcol_to_cell(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19, col)
					start_range = xl_rowcol_to_cell(number_rows_preroll_summary+number_rows_video_preroll_summary+19,col)
					end_range = xl_rowcol_to_cell(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+18,col)
				...
				for col in range(number_cols_interaction_final-1,number_cols_interaction_final):
					cell_location = xl_rowcol_to_cell(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19, col)
					start_range = xl_rowcol_to_cell(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19, col+1)
				...
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+18,0,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary
				                             +number_rows_interaction_final+19,0,{"type":"blanks","format":format_border_right})
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+18,number_cols_interaction_final+1,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19,0,
				                             {"type":"blanks","format":format_border_left})
				
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+20,1,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary
				                             +number_rows_interaction_final+20,number_cols_interaction_final,{"type":"blanks","format":format_border_top})
				
				worksheet.conditional_format(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+19,1,
				                             number_rows_preroll_summary+number_rows_video_preroll_summary
				                             +number_rows_interaction_final+19,number_cols_interaction_final,{"type":"no_blanks","format":format_headers})
			...
			if check_day_preroll_summary_final is True:
				...
				worksheet.write_formula(row_end+3,2,'=SUMIF(B{}:B{},"Subtotal",C{}:C{})'.format(row_start,row_end,row_start,
				                                                                               row_end),format_number)
				worksheet.write_formula(row_end+3,3,'=SUMIF(B{}:B{},"Subtotal",D{}:D{})'.format(row_start,row_end,row_start,
				                                                                               row_end),format_number)
				worksheet.write_formula(row_end+3,4,'=IFERROR(D{}/C{},0)'.format(row_end+4,row_end+4),percent_fmt)
				worksheet.write_formula( row_end+3, 5, '=SUMIF(B{}:B{},"Subtotal",F{}:F{})'.format(row_start, row_end, row_start,
				                                                                                  row_end),format_number)
				worksheet.write_formula(row_end+3,6,'=IFERROR((F{}/C{}),0)'.format(row_end+4,row_end+4),percent_fmt)
				
				worksheet.conditional_format(row_end+3,2,row_end+3,6,{"type":"no_blanks","format":format_headers})
				worksheet.conditional_format(row_end+3,0,row_end+3,0,{"type":"blanks","format":format_border_right})
				worksheet.conditional_format(row_end+2,1,row_end+2,6,{"type":"blanks", "format":format_border_bottom})
				worksheet.conditional_format(row_end+3,7,row_end+3,7,{"type":"blanks","format":format_border_left})
				worksheet.conditional_format(row_end+4,1,row_end+4,6,{"type":"blanks","format":format_border_top})
			#formatPlacementByDateHeader = workbook.add_format({"bg_color":'#595959', 'font_color':'#FFFFFF', "bold":True, "align":"center"})
			
			
			#row_start = number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+24
			#row_end = number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final\
			...
			format_merge_row_black = workbook.add_format({"bold":True, "font_color":'#000000', "align":"centre",
			                                           "fg_color":"#00B0F0", "border":2, "border_color":"#000000"})
			
			if check_day_preroll_summary_final is True:
				pass
			else:
				worksheet.merge_range(number_rows_preroll_summary+number_rows_video_preroll_summary+number_rows_interaction_final+22
